package com.insp.edu.book.oo.medium.charter1.e1_4_2;
...
public class ListElementDemo {
	...
	public static void main(String[] args) {
		...
		MyDynamicArray<Geometry> list = new MyDynamicArray<Geometry>();//MyDynamicArray类定义中的模板类型现在被Geometry替换，Geometry是一个具体的类型了，这意味着list.add(T t)方法的T是且只能是Geometry
		while(true){
			//输入坐标字符串
